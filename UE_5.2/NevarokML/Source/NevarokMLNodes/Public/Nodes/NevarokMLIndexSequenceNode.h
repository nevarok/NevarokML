...
#include "NevarokMLIndexSequenceNode.generated.h"

UCLASS()
class NEVAROKMLNODES_API UNevarokMLIndexSequenceNode : public UK2Node, public IK2Node_AddPinInterface
{
    GENERATED_BODY()

protected:
    static const FName IndexOffsetPinName;
    static const FName IndexStepPinName;
    static const FName CompleteIndexPinName;
    
    UEdGraphPin* GetExecPinBy(int index) const;
    UEdGraphPin* GetIndexPinBy(int index) const;
    UEdGraphPin* GetInLimitPinBy(int index) const;
    UEdGraphPin* GetInNamePinBy(int index) const;
    UEdGraphPin* GetOutNamePinBy(int index) const;
    UEdGraphPin* GetOutLimitPinBy(int index) const;
    UEdGraphPin* GetIndexOffsetPin() const;
    UEdGraphPin* GetIndexStepPin() const;
    UEdGraphPin* GetCompleteIndexPin() const;
    UEdGraphPin* GetCompletePin() const;
    virtual void CreateIndexOffsetPin();
    virtual void CreateIndexStepPin();

    virtual void CreateCompleteIndexPin();
    ...
    UEdGraphPin* CreateExecOutPin(FCreatePinParams params = FCreatePinParams());
    virtual UEdGraphPin* CreateIndexOutPin(FCreatePinParams params = FCreatePinParams());
    UEdGraphPin* CreateNameInPin(FCreatePinParams params = FCreatePinParams());
    UEdGraphPin* CreateNameOutPin(FCreatePinParams params = FCreatePinParams());

    FName GetUniqueIndexPinName() const;
    FName GetUniqueInNamePinName() const;
    FName GetUniqueOutNamePinName() const;
    FName GetUniqueInLimitPinName() const;
    FName GetUniqueOutLimitPinName() const;
    FName GetUniquePinName() const;

    int GetThenPinsCount() const;
    bool CanRemoveExecutionPin() const;

    virtual UEdGraphPin* CreateLimitInPin(FCreatePinParams params = FCreatePinParams());
    virtual UEdGraphPin* CreateLimitOutPin(FCreatePinParams params = FCreatePinParams());
    void RemoveLastPin(FName targetPinName);
    void MarkBlueprintAsModified() const;
    void RemovePin(FName targetPinName);
    void InsertPin(FName targetPinName, EPinInsertPosition position);
    ...
    virtual FName GetExecPinNameGivenIndex(int32 index) const;
    static FName GetInLimitPinNameGivenIndex(int32 index);
    static FName GetOutLimitPinNameGivenIndex(int32 index);
    virtual void ExpandNode(FKismetCompilerContext& compilerContext, UEdGraph* sourceGraph) override;
    UEdGraphPin* AssignOutPins(FKismetCompilerContext& compilerContext, UEdGraph* sourceGraph,
                               const UEdGraphSchema_K2* schema,
                               UK2Node_ExecutionSequence* sequence, UEdGraphPin* indexPin,
                               UEdGraphPin* indexOffsetPin, UEdGraphPin* indexStepPin, const int index);
    virtual UEdGraphPin* CreateTempIndexPin(FKismetCompilerContext& compilerContext, UEdGraph* sourceGraph);
    virtual UEdGraphPin* CreateTempLimitPin(FKismetCompilerContext& compilerContext, UEdGraph* sourceGraph);
    UEdGraphPin* CreateTempNamePin(FKismetCompilerContext& compilerContext, UEdGraph* sourceGraph);
    virtual UK2Node_CallFunction* CreateAddFunc(FKismetCompilerContext& compilerContext, UEdGraph* sourceGraph);
    virtual UK2Node_CallFunction* CreateMultFunc(FKismetCompilerContext& compilerContext, UEdGraph* sourceGraph);
    virtual void GetNodeContextMenuActions(UToolMenu* menu, UGraphNodeContextMenuContext* context) const override;
    static FName GetIndexPinNameGivenIndex(int32 index);
    static FName GetInNamePinNameGivenIndex(int32 index);
    static FName GetOutNamePinNameGivenIndex(int32 index);
};
