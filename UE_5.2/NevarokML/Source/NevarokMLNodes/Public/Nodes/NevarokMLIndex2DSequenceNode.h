...
#include "K2Node.h"
#include "NevarokMLIndexSequenceNode.h"
#include "EdGraph/EdGraphPin.h"
#include "NevarokMLIndex2DSequenceNode.generated.h"

UCLASS()
class NEVAROKMLNODES_API UNevarokMLIndex2DSequenceNode : public UNevarokMLIndexSequenceNode
{
    GENERATED_BODY()

    virtual UEdGraphPin* CreateTempIndexPin(FKismetCompilerContext& compilerContext, UEdGraph* sourceGraph) override;
    virtual UK2Node_CallFunction* CreateAddFunc(FKismetCompilerContext& compilerContext, UEdGraph* sourceGraph) override;
    virtual UK2Node_CallFunction* CreateMultFunc(FKismetCompilerContext& compilerContext, UEdGraph* sourceGraph) override;

    virtual void CreateIndexStepPin() override;
    virtual void CreateIndexOffsetPin() override;
    virtual void CreateCompleteIndexPin() override;
    virtual UEdGraphPin* CreateIndexOutPin(FCreatePinParams params = FCreatePinParams()) override;
    virtual UEdGraphPin* CreateLimitInPin(FCreatePinParams params = FCreatePinParams()) override;
    virtual UEdGraphPin* CreateLimitOutPin(FCreatePinParams params = FCreatePinParams()) override;
    virtual UEdGraphPin* CreateTempLimitPin(FKismetCompilerContext& compilerContext, UEdGraph* sourceGraph) override;
