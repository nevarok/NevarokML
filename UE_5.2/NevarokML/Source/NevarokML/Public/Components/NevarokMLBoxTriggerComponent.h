...
#include "NevarokMLBoxTriggerComponent.generated.h"

UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class NEVAROKML_API UNevarokMLBoxTriggerComponent : public UBoxComponent
{
    GENERATED_BODY()
...
private:
    ...
    UPROPERTY(EditAnywhere, Category="NevarokML|BoxTriggerComponent", meta=(AllowPrivateAccess))
    TArray<FName> _triggerTags;
public:
    UNevarokMLBoxTriggerComponent();
