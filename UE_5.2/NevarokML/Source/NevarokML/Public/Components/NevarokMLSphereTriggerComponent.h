...
#include "NevarokMLSphereTriggerComponent.generated.h"

UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class NEVAROKML_API UNevarokMLSphereTriggerComponent : public USphereComponent
{
    GENERATED_BODY()
...
private:
    ...
    UPROPERTY(EditAnywhere, Category="NevarokML|SphereTriggerComponent", meta=(AllowPrivateAccess))
    TArray<FName> _triggerTags;
public:
    UNevarokMLSphereTriggerComponent();
    ...
    UFUNCTION(BlueprintCallable, Category="NevarokML|SphereTriggerComponent")
    void ResetTrigger() { _counter = 0; }

    UFUNCTION(BlueprintPure, Category="NevarokML|SphereTriggerComponent")
    bool IsTriggered() const { return _counter > 0; }
};
