...
#include "NevarokMLTraceSensorComponent.generated.h"


UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class NEVAROKML_API UNevarokMLTraceSensorComponent : public USceneComponent
{
    GENERATED_BODY()

public:    
    UPROPERTY(EditAnywhere, Category="NevarokML|TraceSensorComponent")
    FLinearColor TraceColor = FLinearColor::Red;
    
    UPROPERTY(EditAnywhere, Category="NevarokML|TraceSensorComponent")
    FLinearColor TraceHitColor = FLinearColor::Green;
    
    UNevarokMLTraceSensorComponent();

    UFUNCTION(BlueprintCallable, Category="NevarokML|PawnMovementInputComponent")
    void SampleBoxLineTrace(UPARAM(ref)UNevarokMLSample* sample,
                            const float traceLength,
                            const ETraceTypeQuery traceChannel,
                            UPARAM(ref)const TArray<AActor*>& ignoreActors,
                            ...
                            const bool debugLog, const float debugDuration, const FLinearColor debugColor);
};
