...
#include "NevarokMLActorInputComponent.generated.h"

UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class NEVAROKML_API UNevarokMLActorInputComponent : public UActorComponent
{
    GENERATED_BODY()

public:
    UNevarokMLActorInputComponent();
                               
    UFUNCTION(BlueprintCallable, Category="NevarokML|ActorInputComponent")
    bool AddDiscreteRotationInput(int64 value = -1,
                                  int condition = -1,
