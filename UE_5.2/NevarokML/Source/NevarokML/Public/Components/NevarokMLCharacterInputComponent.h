...
#include "NevarokMLCharacterInputComponent.generated.h"


UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class NEVAROKML_API UNevarokMLCharacterInputComponent : public UActorComponent
{
    GENERATED_BODY()

private:
    UPROPERTY(Transient, DuplicateTransient)
    TObjectPtr<ACharacter> _character;
    
public:
    UNevarokMLCharacterInputComponent();

    UFUNCTION(BlueprintCallable, Category="NevarokML|CharacterInputComponent")
    void EnableMovementTick(bool enable) const;

    UFUNCTION(BlueprintCallable, Category="NevarokML|CharacterInputComponent")
    void ForceMovementTick() const;
protected:
...
public:
    UFUNCTION(BlueprintCallable, Category="NevarokML|CharacterInputComponent")
    bool AddDiscreteWorldMoveInput(int64 value = -1,
                                   int left = -1,
                                   int forwardLeft = -1,
                                   int forward = -1,
                                   int forwardRight = -1,
    ...
    UFUNCTION(BlueprintCallable, Category="NevarokML|CharacterInputComponent")
    bool AddDiscreteAxisMoveInput(int64 value = -1,
                                  int left = -1,
                                  int forwardLeft = -1,
                                  int forward = -1,
                                  int forwardRight = -1,
    ...
    UFUNCTION(BlueprintCallable, Category="NevarokML|CharacterInputComponent")
    bool AddDiscreteTurnInput(int64 value = -1,
                              int left = -1,
                              int right = -1,
                              float turnRate = 60.0,
                              bool groundedOnly = true);
    ...
    UFUNCTION(BlueprintCallable, Category="NevarokML|CharacterInputComponent")
    bool AddDiscreteJumpInput(int64 value, int jump = -1, bool groundedOnly = true, bool simulateTick = false);

    UFUNCTION(BlueprintCallable, Category="NevarokML|CharacterInputComponent")
    void ResetInput();

    UFUNCTION(BlueprintPure, Category="NevarokML|CharacterInputComponent")
