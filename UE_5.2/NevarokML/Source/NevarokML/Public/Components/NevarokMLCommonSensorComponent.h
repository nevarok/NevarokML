...
#include "NevarokMLCommonSensorComponent.generated.h"

UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableComponent))
class NEVAROKML_API UNevarokMLCommonSensorComponent : public UActorComponent
{
    GENERATED_BODY()

public:
    UNevarokMLCommonSensorComponent();

    virtual void BeginPlay() override;

    UFUNCTION(BlueprintCallable, Category="NevarokML|CommonSensorComponent")
    void SampleBoxVelocity(UNevarokMLSample* sample,
    ...
    UFUNCTION(BlueprintCallable, Category="NevarokML|CommonSensorComponent")
    void SampleBoxRotation(UNevarokMLSample* sample,
                           const float multiplier,
    ...
    UFUNCTION(BlueprintCallable, Category="NevarokML|CommonSensorComponent")
    void SampleBoxForward(UNevarokMLSample* sample,
    ...
    UFUNCTION(BlueprintCallable, Category="NevarokML|CommonSensorComponent")
    void SampleBoxDifference(UNevarokMLSample* sample,
                             const AActor* to,
                             const float multiplier,
                             const float maxSize,
