...
#include "NevarokMLBaseAlgorithm.generated.h"

UCLASS(Blueprintable)
class NEVAROKML_API UNevarokMLBaseAlgorithm final : public UObject
{
    GENERATED_BODY()

private:
    ENevarokMLAlgorithm _algorithm;
    ENevarokMLPolicy _policy = ENevarokMLPolicy::MLP_POLICY;
    ...
    float _rmsPropEps;
    bool _useRmsProp;
    bool _normalizeAdvantage;
    int _bufferSize;
    int _learningStarts;
    float _tau;
    int _gradientSteps;
    bool _optimizeMemoryUsage;
    int _targetUpdateInterval;
    float _explorationFraction;
    float _explorationInitialEps;
    float _explorationFinalEps;
    bool _useSdeAtWarmup;
    int _policyDelay;
    float _targetPolicyNoise;
    float _targetNoiseClip;
    int _trainFreq;
    bool _entCoefAuto;
    bool _targetEntropyAuto;
    float _targetEntropy;

public:
    ENevarokMLAlgorithm GetAlgorithmType() const { return _algorithm; }
    ENevarokMLPolicy GetPolicyType() const { return _policy; }
