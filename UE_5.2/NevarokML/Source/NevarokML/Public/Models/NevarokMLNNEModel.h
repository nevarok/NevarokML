...
#include "NevarokMLNNEModel.generated.h"

USTRUCT(BlueprintType)
struct NEVAROKML_API FNevarokMLNNETensor
{
    GENERATED_BODY()
...
class NEVAROKML_API UNevarokMLNNEModel final : public UObject
{
    GENERATED_BODY()

private:
    TSharedPtr<UE::NNECore::IModelCPU> _cpuModel;
    ...
    UPROPERTY()
    TArray<FNevarokMLNNETensor> _inputTensors;

    UPROPERTY()
    TArray<FNevarokMLNNETensor> _outputTensors;

    TArray<UE::NNECore::FTensorBindingCPU> _inputBindings;
    TArray<UE::NNECore::FTensorBindingCPU> _outputBindings;

    void InitBindings(TArray<UE::NNECore::FTensorBindingCPU>& bindings,
...
public:
    ...
    static bool Predict(UPARAM(ref)UNevarokMLNNEModel* model);

    UFUNCTION(BlueprintPure, Category = "NevarokML|NNEModel")
    static UNevarokMLNNEModel* NNEModel(UObject* owner, UNNEModelData* modelData, UNevarokMLSample* actionSample,
                                        UNevarokMLSample* observationSample, bool& valid);
};
